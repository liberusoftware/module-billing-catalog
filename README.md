...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-billing-catalog?sort=semver)](https://github.com/liberusoftware/module-billing-catalog/releases/latest) [![Tests](https://github.com/liberusoftware/module-billing-catalog/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-billing-catalog/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-billing-catalog
```
...
<a href="https://github.com/liberusoftware/module-billing-catalog/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-billing-catalog" alt="Contributors to liberusoftware/module-billing-catalog">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-billing-catalog/graphs/contributors).
